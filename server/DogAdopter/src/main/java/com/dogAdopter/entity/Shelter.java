...
@Entity
@NamedQueries({ @NamedQuery(name = Shelter.GET_ALL, query = "FROM Shelter shelter"),
...
public class Shelter implements Serializable {
	...
	@Column(name = "latitude", unique = false, nullable = true, length = 45)
	...
	@Column(name = "longitude", unique = false, nullable = true, length = 45)
